...
double CalculateTotalFaceArea() {
    ...
    ofstream file;
    file.open("C:\\Users\\gavin\\OneDrive - University College London\\ALL_CARVINGS_4_MESHNET\\NON-CARVINGS\\check595.csv");
        ...
        while (true) {
            ...
            if (iteration > smallIndexPerc * numParticles) {
                if (IndexSmallDone == false) {
                    ...
                    // pointsSlice was initialised in the inner loop with a dimension that was larger than needed
            ...
            if (IsInsideMesh(p)) {
                ...
                if (d < m_AttractionDistance) {
                    ...
                    // if random no. matches with laser lichen probability parameters then
...
int main(int argc, char* argv[]) {
    ...
    // area of seed divided by ((0.01^2)*pi)*200. This is the number of points (200) in the z-collapsed 
